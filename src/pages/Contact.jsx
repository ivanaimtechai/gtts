...
import { Mail, Phone, MapPin, User, ChevronDown, AtSign, Pencil, ShieldAlert } from 'lucide-react'
  ...
  return (
    <div className="card">
      ...
      >
        ...
        <Select label="Topic" options={['Select a topic', 'Course Question', 'Billing', 'Certificate', 'Partner Inquiry', 'Other']} />
    ...
    <div className="card">
      ...
      <ul className="mt-5 space-y-5">
        <li className="flex gap-4">
          <span className="h-10 w-10 shrink-0 rounded-full bg-brand-softblue text-brand-blue flex items-center justify-center">
            <Phone className="h-5 w-5" />
          </span>
          <div>
            <div className="font-semibold text-brand-navy">Phone</div>
            <a href="tel:1-888-329-7069" className="text-brand-blue text-sm">1-888-329-7069</a>
            <div className="text-xs text-brand-navy/60 mt-0.5">Mon–Fri: 5AM–10PM PT</div>
          </div>
        </li>
        <li className="flex gap-4">
          <span className="h-10 w-10 shrink-0 rounded-full bg-brand-softblue text-brand-blue flex items-center justify-center">
          ...
          <div>
            ...
            <a href="mailto:info@gototrafficschool.com" className="text-brand-blue text-sm">info@gototrafficschool.com</a>
            <div className="text-xs text-brand-navy/60 mt-0.5">We typically respond within 24 hours</div>
          </div>
        </li>
        <li className="flex gap-4">
          <span className="h-10 w-10 shrink-0 rounded-full bg-brand-softblue text-brand-blue flex items-center justify-center">
          ...
          <div>
            <div className="font-semibold text-brand-navy">Office Address</div>
            <div className="text-sm text-brand-navy/85">Beverly Hills, CA</div>
          </div>
        </li>
      </ul>
    </div>
